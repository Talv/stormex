...
#pragma once
#include "mplog/ConsoleAppenderStderr.h"
#include <plog/WinApi.h>

namespace plog
{
    template<class Formatter>
    class ColorConsoleAppenderStdErr : public ConsoleAppenderStderr<Formatter>
    {
    public:
#ifdef _WIN32
        ColorConsoleAppenderStdErr() : m_originalAttr()
        {
            if (this->m_isatty)
            {
